...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['SphereonSDKBarcode/ApiClient', 'SphereonSDKBarcode/model/Lifecycle'], factory);
   ...
   * @module SphereonSDKBarcode/model/ReaderJobSettings
   * @version 0.1.0
   */
   ...
   * @alias module:SphereonSDKBarcode/model/ReaderJobSettings
   * @class
   */
   ...
   * @param {module:SphereonSDKBarcode/model/ReaderJobSettings} obj Optional instance to populate.
   * @return {module:SphereonSDKBarcode/model/ReaderJobSettings} The populated <code>ReaderJobSettings</code> instance.
   */
  ...
  /**
   * @member {module:SphereonSDKBarcode/model/Lifecycle} lifecycle
   */
  ...
  /**
   * @member {module:SphereonSDKBarcode/model/ReaderJobSettings.EngineEnum} engine
   */
  exports.prototype['engine'] = undefined;
  /**
   * @member {module:SphereonSDKBarcode/model/ReaderJobSettings.OutputFileFormatEnum} outputFileFormat
   */
