...
(function(root, factory) {
   ...
   * @module SphereonSDKBarcode/model/ErrorResponse
   * @version 0.1.0
   */
   ...
   * The error response
   * @alias module:SphereonSDKBarcode/model/ErrorResponse
   * @class
   */
   ...
   * @param {module:SphereonSDKBarcode/model/ErrorResponse} obj Optional instance to populate.
   * @return {module:SphereonSDKBarcode/model/ErrorResponse} The populated <code>ErrorResponse</code> instance.
   */
  ...
  /**
   * @member {Array.<module:SphereonSDKBarcode/model/Error>} errors
   */
