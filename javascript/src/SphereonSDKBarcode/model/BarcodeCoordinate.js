...
(function(root, factory) {
   ...
   * @module SphereonSDKBarcode/model/BarcodeCoordinate
   * @version 0.1.0
   */

  /**
   * Constructs a new <code>BarcodeCoordinate</code>.
   * @alias module:SphereonSDKBarcode/model/BarcodeCoordinate
   * @class
   */
   ...
   * @param {module:SphereonSDKBarcode/model/BarcodeCoordinate} obj Optional instance to populate.
   * @return {module:SphereonSDKBarcode/model/BarcodeCoordinate} The populated <code>BarcodeCoordinate</code> instance.
   */
   ...
   * @member {module:SphereonSDKBarcode/model/BarcodeCoordinate.AnchorEnum} anchor
   */
