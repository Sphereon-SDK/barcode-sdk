...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['SphereonSDKBarcode/ApiClient', 'SphereonSDKBarcode/model/ReaderJobSettings'], factory);
   ...
   * @module SphereonSDKBarcode/model/ReaderJob
   * @version 0.1.0
   */
   ...
   * @alias module:SphereonSDKBarcode/model/ReaderJob
   * @class
   ...
   * @param {module:SphereonSDKBarcode/model/ReaderJob} obj Optional instance to populate.
   * @return {module:SphereonSDKBarcode/model/ReaderJob} The populated <code>ReaderJob</code> instance.
   */
  ...
  /**
   * @member {module:SphereonSDKBarcode/model/ReaderJobSettings} settings
   */
