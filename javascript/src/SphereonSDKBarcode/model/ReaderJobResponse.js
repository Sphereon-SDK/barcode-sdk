...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['SphereonSDKBarcode/ApiClient', 'SphereonSDKBarcode/model/ReaderEngineTask', 'SphereonSDKBarcode/model/ReaderJob'], factory);
   ...
   * @module SphereonSDKBarcode/model/ReaderJobResponse
   * @version 0.1.0
   */
   ...
   * @alias module:SphereonSDKBarcode/model/ReaderJobResponse
   * @class
   * @param inputs {Array.<String>} The original input files. Currently supported inputs are: tif files
   * @param status {module:SphereonSDKBarcode/model/ReaderJobResponse.StatusEnum} The status of the job
   */
   ...
   * @param {module:SphereonSDKBarcode/model/ReaderJobResponse} obj Optional instance to populate.
   * @return {module:SphereonSDKBarcode/model/ReaderJobResponse} The populated <code>ReaderJobResponse</code> instance.
   */
   ...
   * @member {module:SphereonSDKBarcode/model/ReaderJobResponse.StatusEnum} status
   */
