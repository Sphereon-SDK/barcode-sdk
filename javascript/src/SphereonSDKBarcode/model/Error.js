...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['SphereonSDKBarcode/ApiClient', 'SphereonSDKBarcode/model/Error'], factory);
   ...
   * @module SphereonSDKBarcode/model/Error
   * @version 0.1.0
   */
   ...
   * An error
   * @alias module:SphereonSDKBarcode/model/Error
   * @class
   * @param code {String} 
   * @param level {module:SphereonSDKBarcode/model/Error.LevelEnum} 
   ...
   * @param {module:SphereonSDKBarcode/model/Error} obj Optional instance to populate.
   * @return {module:SphereonSDKBarcode/model/Error} The populated <code>Error</code> instance.
   */
  ...
  /**
   * @member {module:SphereonSDKBarcode/model/Error.LevelEnum} level
   */
  exports.prototype['level'] = undefined;
  /**
   * @member {module:SphereonSDKBarcode/model/Error} cause
   */
