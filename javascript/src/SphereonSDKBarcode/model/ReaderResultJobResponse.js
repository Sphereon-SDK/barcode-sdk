...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['SphereonSDKBarcode/ApiClient', 'SphereonSDKBarcode/model/Barcode', 'SphereonSDKBarcode/model/ReaderEngineTask', 'SphereonSDKBarcode/model/ReaderJob'], factory);
   ...
   * @module SphereonSDKBarcode/model/ReaderResultJobResponse
   * @version 0.1.0
   */
   ...
   * @alias module:SphereonSDKBarcode/model/ReaderResultJobResponse
   * @class
   * @param inputs {Array.<String>} The original input files. Currently supported inputs are: tif files
   * @param barcodes {Array.<module:SphereonSDKBarcode/model/Barcode>} The returned barcodes
   * @param status {module:SphereonSDKBarcode/model/ReaderResultJobResponse.StatusEnum} The status of the job
   */
   ...
   * @param {module:SphereonSDKBarcode/model/ReaderResultJobResponse} obj Optional instance to populate.
   * @return {module:SphereonSDKBarcode/model/ReaderResultJobResponse} The populated <code>ReaderResultJobResponse</code> instance.
   */
   ...
   * @member {Array.<module:SphereonSDKBarcode/model/Barcode>} barcodes
   */
  exports.prototype['barcodes'] = undefined;
  /**
   * @member {module:SphereonSDKBarcode/model/ReaderJob} job
   */
   ...
   * @member {Array.<module:SphereonSDKBarcode/model/ReaderEngineTask>} tasks
   */
   ...
   * @member {module:SphereonSDKBarcode/model/ReaderResultJobResponse.StatusEnum} status
   */
