...
(function(root, factory) {
  ...
  /**
   * @module SphereonSDKBarcode/ApiClient
   * @version 0.1.0
   */
   ...
   * @alias module:SphereonSDKBarcode/ApiClient
   * @class
   */
   ...
   * @param {module:SphereonSDKBarcode/ApiClient.CollectionFormatEnum} collectionFormat The array element separator strategy.
   ...
   * @callback module:SphereonSDKBarcode/ApiClient~callApiCallback
   ...
   * @param {module:SphereonSDKBarcode/ApiClient~callApiCallback} callback The callback function.
   ...
   * @type {module:SphereonSDKBarcode/ApiClient}
   */
