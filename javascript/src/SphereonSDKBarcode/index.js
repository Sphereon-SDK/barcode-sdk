...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['SphereonSDKBarcode/ApiClient', 'SphereonSDKBarcode/model/Barcode', 'SphereonSDKBarcode/model/BarcodeCoordinate', 'SphereonSDKBarcode/model/Error', 'SphereonSDKBarcode/model/ErrorResponse', 'SphereonSDKBarcode/model/Lifecycle', 'SphereonSDKBarcode/model/ReaderEngineTask', 'SphereonSDKBarcode/model/ReaderJob', 'SphereonSDKBarcode/model/ReaderJobResponse', 'SphereonSDKBarcode/model/ReaderJobSettings', 'SphereonSDKBarcode/model/ReaderResultJobResponse', 'SphereonSDKBarcode/api/BarcodeReaderApi'], factory);
   ...
   * <pre>
   * var Barcode = require('SphereonSDKBarcode/index'); // See note below*.
   ...
   * ...
   * </pre>
   * <em>*NOTE: For a top-level AMD script, use require(['SphereonSDKBarcode/index'], function(){...})
   ...
   * </pre>
   * </p>
   * @module SphereonSDKBarcode/index
   * @version 0.1.0
   */
  var exports = {
    /**
     * The ApiClient constructor.
     * @property {module:SphereonSDKBarcode/ApiClient}
     */
    ApiClient: ApiClient,
    /**
     * The Barcode model constructor.
     * @property {module:SphereonSDKBarcode/model/Barcode}
     */
    Barcode: Barcode,
    /**
     * The BarcodeCoordinate model constructor.
     * @property {module:SphereonSDKBarcode/model/BarcodeCoordinate}
     */
    BarcodeCoordinate: BarcodeCoordinate,
    /**
     * The Error model constructor.
     * @property {module:SphereonSDKBarcode/model/Error}
     */
    Error: Error,
    /**
     * The ErrorResponse model constructor.
     * @property {module:SphereonSDKBarcode/model/ErrorResponse}
     */
    ErrorResponse: ErrorResponse,
    /**
     * The Lifecycle model constructor.
     * @property {module:SphereonSDKBarcode/model/Lifecycle}
     */
    Lifecycle: Lifecycle,
    /**
     * The ReaderEngineTask model constructor.
     * @property {module:SphereonSDKBarcode/model/ReaderEngineTask}
     */
    ReaderEngineTask: ReaderEngineTask,
    /**
     * The ReaderJob model constructor.
     * @property {module:SphereonSDKBarcode/model/ReaderJob}
     */
    ReaderJob: ReaderJob,
    /**
     * The ReaderJobResponse model constructor.
     * @property {module:SphereonSDKBarcode/model/ReaderJobResponse}
     */
    ReaderJobResponse: ReaderJobResponse,
    /**
     * The ReaderJobSettings model constructor.
     * @property {module:SphereonSDKBarcode/model/ReaderJobSettings}
     */
    ReaderJobSettings: ReaderJobSettings,
    /**
     * The ReaderResultJobResponse model constructor.
     * @property {module:SphereonSDKBarcode/model/ReaderResultJobResponse}
     */
    ReaderResultJobResponse: ReaderResultJobResponse,
    /**
     * The BarcodeReaderApi service constructor.
     * @property {module:SphereonSDKBarcode/api/BarcodeReaderApi}
     */
