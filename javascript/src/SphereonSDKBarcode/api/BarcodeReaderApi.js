...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['SphereonSDKBarcode/ApiClient', 'SphereonSDKBarcode/model/ReaderJobResponse', 'SphereonSDKBarcode/model/ErrorResponse', 'SphereonSDKBarcode/model/ReaderResultJobResponse', 'SphereonSDKBarcode/model/ReaderJob'], factory);
   ...
   * @module SphereonSDKBarcode/api/BarcodeReaderApi
   * @version 0.1.0
   */

  /**
   * Constructs a new BarcodeReaderApi. 
   * @alias module:SphereonSDKBarcode/api/BarcodeReaderApi
   * @class
   * @param {module:SphereonSDKBarcode/ApiClient} apiClient Optional API client implementation to use,
   * default to {@link module:SphereonSDKBarcode/ApiClient#instance} if unspecified.
   */
  var exports = function(apiClient) {
     ...
     * @callback module:SphereonSDKBarcode/api/BarcodeReaderApi~deleteJobCallback
     * @param {String} error Error message, if any.
     * @param {module:SphereonSDKBarcode/model/ReaderJobResponse} data The data returned by the service call.
     ...
     * @param {module:SphereonSDKBarcode/api/BarcodeReaderApi~deleteJobCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:SphereonSDKBarcode/model/ReaderJobResponse}
     */
     ...
     * @callback module:SphereonSDKBarcode/api/BarcodeReaderApi~getJobCallback
     * @param {String} error Error message, if any.
     * @param {module:SphereonSDKBarcode/model/ReaderResultJobResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} jobid jobid
     * @param {module:SphereonSDKBarcode/api/BarcodeReaderApi~getJobCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:SphereonSDKBarcode/model/ReaderResultJobResponse}
     */
     ...
     * @callback module:SphereonSDKBarcode/api/BarcodeReaderApi~submitJobCallback
     * @param {String} error Error message, if any.
     * @param {module:SphereonSDKBarcode/model/ReaderJobResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} jobid jobid
     * @param {module:SphereonSDKBarcode/model/ReaderJob} job jobEntity
     * @param {module:SphereonSDKBarcode/api/BarcodeReaderApi~submitJobCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:SphereonSDKBarcode/model/ReaderJobResponse}
     */
     ...
     * @callback module:SphereonSDKBarcode/api/BarcodeReaderApi~uploadFileCallback
     * @param {String} error Error message, if any.
     * @param {module:SphereonSDKBarcode/model/ReaderJobResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:SphereonSDKBarcode/api/BarcodeReaderApi~uploadFileCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:SphereonSDKBarcode/model/ReaderJobResponse}
     */
