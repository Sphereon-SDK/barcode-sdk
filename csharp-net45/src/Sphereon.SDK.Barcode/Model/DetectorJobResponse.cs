...
namespace Sphereon.SDK.Barcode.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DetectorJobResponse :  IEquatable<DetectorJobResponse>
    {
        /// <summary>
        ...
        public DetectorJobResponse(List<DetectorTask> DetectorTasks = null, List<Barcode> BarcodeResults = null, string JobId = null, List<string> Inputs = null, DetectorJob Job = null)
        {
            ...
            if (Inputs == null)
            {
                throw new InvalidDataException("Inputs is a required property for DetectorJobResponse and cannot be null");
            }
            else
            {
                this.Inputs = Inputs;
        ...
        public List<Barcode> BarcodeResults { get; set; }
        /// <summary>
        ...
        public DetectorJob Job { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as DetectorJobResponse);
        }

        /// <summary>
        /// Returns true if DetectorJobResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of DetectorJobResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DetectorJobResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
