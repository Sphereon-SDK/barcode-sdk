...
```
nuget pack -Build -OutputDirectory out Sphereon.SDK.Barcode.csproj
```
...
------------ | ------------- | ------------- | -------------
*BarcodeReaderApi* | [**DeleteJob**](docs/BarcodeReaderApi.md#deletejob) | **DELETE** /barcode/0.1/reader/{jobid} | Delete a job manually
*BarcodeReaderApi* | [**GetJob**](docs/BarcodeReaderApi.md#getjob) | **GET** /barcode/0.1/reader/{jobid} | Job definition and state
*BarcodeReaderApi* | [**SubmitJob**](docs/BarcodeReaderApi.md#submitjob) | **PUT** /barcode/0.1/reader/{jobid} | Submit job for reading
*BarcodeReaderApi* | [**UploadFile**](docs/BarcodeReaderApi.md#uploadfile) | **POST** /barcode/0.1/reader | Upload the file
